...
\paragraph{Unit 8: Sensitivity analysis and partial identification.}
\begin{itemize}
\item Omitted variable bias (OVB) for bounding OLS.
\item Sensitivity for IV and other strategies.
\item Placebo treatments and outcomes.
\item Stability-controlled quasi-experiments.
