...
\begin{center}\includegraphics[height=.35\textheight]{Maha1.pdf}\end{center}
...
\includegraphics[width=.6\textwidth]{lalonde_pscore.pdf}
\end{center}
...
\begin{center}\includegraphics[width=.7\textwidth]{lalonde_ipw_weights.pdf}\end{center}
\begin{itemize}
